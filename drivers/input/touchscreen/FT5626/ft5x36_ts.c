...
extern bool ft_gesture_enable;
bool ft_gesture_enable_dtsi;
...
/*modified for  [SW00188085] by miaoxiliang 2016.7.7 begin*/
#ifdef FT_ENABLE_GESTURE_WAKEUP
static ssize_t ft5x36_gesture_read_proc(struct file *, char __user *, size_t, loff_t *);
static ssize_t ft5x36_gesture_write_proc(struct file *, const char __user *, size_t, loff_t *);
static DEFINE_MUTEX(g_device_mutex);
static struct proc_dir_entry *ft5x36_gesture_proc = NULL;
static const struct file_operations ft5x36_gesture_proc_fops = {
    .owner = THIS_MODULE,
    .read = ft5x36_gesture_read_proc,
    .write = ft5x36_gesture_write_proc,
};
#endif
/*modified for  [SW00188085] by miaoxiliang 2016.7.7 end*/
...
/*modified for  [SW00188085] by miaoxiliang 2016.7.7 begin*/
	...
	printk( "buf[0]=0x%x check_gesture gestrue_id.\n", buf[0]);
	if (buf[0])
	{
		gesture_id = buf[0];
		return -1;
...
static void fts_report_Gesture(struct fts_ts_data *data)
{
		switch(gesture_id)
    {
				case 0x24:
				{
					printk("<FTS>double click\n");
					/*modified for	[SW00188085] by miaoxiliang 2016.7.12 begin*/
					...
					//input_sync(data->input_dev);
					/*modified for	[SW00188085] by miaoxiliang 2016.7.12 end*/
					break;
				}
				case 0x22:
				{
...
/*add for  [SW00188085] by miaoxiliang 2016.7.7 begin*/
static ssize_t ft5x36_gesture_read_proc(struct file *file, char __user *buffer, size_t count,  loff_t *ppos)
{
...
static ssize_t ft5x36_gesture_write_proc(struct file *file, const char __user *buffer, size_t count,  loff_t *ppos)
{
	unsigned long  val = 0;
	mutex_lock(&g_device_mutex);
	val = simple_strtoul(buffer, NULL, 10);;
	if(val)
		ft_gesture_enable=true;
	else
		ft_gesture_enable=false;
	mutex_unlock(&g_device_mutex);
 	return count;
}
/*add for  [SW00188085] by miaoxiliang 2016.7.7 end*/
...
#ifdef FT_ENABLE_GESTURE_WAKEUP
/*modified for  [SW00188085] by miaoxiliang 2016.7.7 begin*/
  	if(ft_gesture_enable == 1 && gesture_flag == 1){
...
#ifdef FT_ENABLE_GESTURE_WAKEUP
/*modified for  [SW00188085] by miaoxiliang 2016.7.7 begin*/
	ft_gesture_enable_dtsi= of_property_read_bool(np,
...
static int ft5x36_ts_suspend(struct device *dev)
{
	...
	char txbuf[2];
	/*delete for  [SW00188988 ] by miaoxiliang 2016.7.22 begin*/
#if 0
	int err;
#endif
	/*delete for  [SW00188988 ] by miaoxiliang 2016.7.22 end*/
...
#ifdef FT_ENABLE_GESTURE_WAKEUP
/*modified for  [SW00188085] by miaoxiliang 2016.7.7 begin*/
      	if(ft_gesture_enable == 1 && gesture_flag == 0){
...
/*modified for  [SW00188085] by miaoxiliang 2016.7.7 end*/
              fts_i2c_Write(ft5x36_ts->client,auc_i2c_write_buf,2);
/*add for  [SW00188085] by miaoxiliang 2016.7.7 begin*/
              auc_i2c_write_buf[0] = 0xd5;
              auc_i2c_write_buf[1] = 0x40;
              fts_i2c_Write(ft5x36_ts->client,auc_i2c_write_buf,2);
              auc_i2c_write_buf[0] = 0xd6;
              auc_i2c_write_buf[1] = 0x10;
              fts_i2c_Write(ft5x36_ts->client,auc_i2c_write_buf,2);
              auc_i2c_write_buf[0] = 0xd7;
              auc_i2c_write_buf[1] = 0x20;
              fts_i2c_Write(ft5x36_ts->client,auc_i2c_write_buf,2);
/*add for  [SW00188085] by miaoxiliang 2016.7.7 end*/
...
static void ft5x36_hardware_info_reg(u8 family_id,u8 vendod_id,u8 fw_ver)
{
	...
	else if(family_id==IC_FT5626)
	 strcpy(tmp_tp_name, "IC-FT5626:Module-");
    else{
...
/*modified for  [SW00188085] by miaoxiliang 2016.7.7 begin*/
#ifdef FT_ENABLE_GESTURE_WAKEUP
    ft5x36_gesture_proc = proc_create("gesture_enable", 0666, NULL, &ft5x36_gesture_proc_fops);
	if (ft5x36_gesture_proc == NULL)
	{
		dev_err(&client->dev,"create_proc_entry %s failed", "gesture_enable");
	}
#endif
/*modified for  [SW00188085] by miaoxiliang 2016.7.7 end*/
//modify by pangle for hardware info 20140928 begin
